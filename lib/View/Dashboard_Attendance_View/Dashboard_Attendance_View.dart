...
class _AttendanceCalendarPageState extends State<AttendanceCalendarPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Attendance Calendar", style: TextStyle(fontWeight: FontWeight.bold)),
        backgroundColor: AppColors.backgroundColor,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Chip(
                  label: Text(TextConstants.present, style: const TextStyle(color: Colors.green)),
                  color: WidgetStatePropertyAll(Colors.greenAccent.withOpacity(0.3)),
      ...
      child: Row(
        ...
        children: [
          IconButton(
            ...
            onPressed: () {
              _controller.focusedDayNotifier.value =
                  _controller.goToPreviousMonth(focusedDay);
            },
          ),
          Text(
          ...
          IconButton(
            ...
            onPressed: () {
              _controller.focusedDayNotifier.value =
                  _controller.goToNextMonth(focusedDay);
            },
          ),
        ],
      ),
